...
export default function UploadSong() {
  ...
  return (
    <>
      <StickyNavbar />
      <h1 className="text-center text-3xl mt-4 font-mono text-white">Upload your Musics</h1>
      <div className="flex items-center justify-center w-full mt-6">
        <form onSubmit={handleSubmit} encType="multipart/form-data" method="post" className="flex flex-col items-start justify-center w-[60%] gap-3">
          ...
          {step === 1 && (
            <>
              <h2 className="text-2xl font-semibold text-white">Step 2</h2>
              <div className="w-full">
